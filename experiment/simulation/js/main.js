...
const Scenes = {
  ...
  steps: [
    ...
    (step2 = function () {
      ...
      setIsProcessRunning(true);
      Scenes.items.contentAdderBox.setContent("");
      Scenes.setStepHeading("Step 2", "Placing aluminum beam and timber beam on the top of basic frame.");
    ...
    (step3 = function () {
      setIsProcessRunning(true);
      Dom.hideAll();
      Scenes.setStepHeading("Step 3", "Construct beam using beam forming support (BFS).");
    ...
    (step6 = function () {
      ...
      Scenes.setStepHeading("Step 4", "Construct the slab using CT prop, beam and sheathing.");
